...
imposition to the academic, curricular and co-curricular activities of the colleges</p>
        ...
        if ($type === 'COMMERCE') {
            ...
            $pageContent =
                '
                    <div class="w-full flex justify-end">
                        <a href="' . route('pdfViewer',['folder'=>'departments','file'=>'Commerce']). '" class="text-xs font-semibold underline text-danger" target="_blank">View Document <i class="fa fa-angles-right"></i> </a>

                      </div>' . '


                       <p class="mt-4 text-black  font-bold text-md">ABOUT THE DEPARTMENT:</p>
                       <p class="mt-2 text-darkText italic text-md">Department of commerce at LBS Govt. P.G College Saraswatinagar was established in the year
1997.
</p>
                       <p class="mt-2 text-darkText italic text-md">The course provides the comprehensive knowledge of financial accountancy, Management,
corporate and cost accounting, Indian taxation system, Indian Banking system of India, Economic
system and economic conditions of India business and corporate laws and marketing management.</p>
                       <p class="mt-2 text-darkText italic text-md">The department routinely organize local industrial visit and educational tour to the students.</p>
                       <p class="mt-2 text-darkText italic text-md">Department also organize departmental function and quiz competition.
</p>
                       <p class="mt-2 text-darkText italic text-md">Department provides a comfortable and competitive environment for learning and ensure
grooming for future career.</p>
                       <img src="' . asset('assets/images/courses/Commerce/1.png') . '" alt="" class="rounded-md mt-2">
                       ...
                       <p class="mt-2 text-darkText italic text-md">• Assistant Professor Sandhira Devi MCOM, SLET.
</p>
                       <p class="mt-2 text-darkText italic text-md">Teaching experience of 5 Years</p>
                       <p class="mt-2 text-darkText italic text-md">• Assistant Professor Sandeep kumar MCOM NET and SET SLET.
</p>
                       <p class="mt-2 text-darkText italic text-md">Teaching experience of 3 Years</p>
                       ...
                       <p class="mt-2 text-darkText italic text-md">The teachers of the department adopt various teaching tools to make teaching more effective. The
use of power point presentation in the theory classes.</p>
                       <p class="mt-2 text-darkText italic text-md">The seminars / Presentation by the students. The practical classes are conducted. Interactive
sessions, quiz, debate, Group discussion, class test and assignment are routine features of study.</p>
                       <img src="' . asset('assets/images/courses/Commerce/2.png') . '" alt="" class="rounded-md mt-2">



                       <p class="mt-4 text-black  font-bold text-md">CAPACITY BUILDING:
</p>
                       <p class="mt-2 text-darkText italic text-md">Workshops and seminars are organized for the students and teachers.</p>
                       <p class="mt-2 text-darkText italic text-md">Department also organize excursion for the students. Teachers accompany the students to the visit
of Adani agro fresh limited and they learn about the apple grading and marketing.</p>
                       <img src="' . asset('assets/images/courses/Commerce/3.png') . '" alt="" class="rounded-md mt-2">



                       <p class="mt-4 text-black  font-bold text-md">STUDENTS PROGRESSION AND ACHIEVEMENTS:</p>
                       <p class="mt-2 text-darkText italic text-md">Several students pursue Post graduation on commerce from HPU and many students are doing
civil services and Banking coaching and some are doing C.A.</p>



                       <p class="mt-4 text-black  font-bold text-md">DISTIGUISHED ALUMINAE (Faculty of Commerce)
</p>
                       <p class="mt-2 text-darkText italic text-md">Dr.Neeraj Dhauta Assistant professor APG univ.</p>
...
approved by Academic Council and Executive Council of Himachal Pradesh University. </p>
        ...
        return view('course', compact('title', 'pageContent'));
    }
}

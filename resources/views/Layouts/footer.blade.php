    ...
    <div class="w-full grid lg:grid-cols-4 md:grid-cols-4 grid-cols-1 gap-6  px-4 py-8   mx-auto lg:w-[70%] md:w-[80%] w-[100%  ]">
           <div class="w-full flex flex-col text-white uppercase">
            ...
            <ul class="mt-4 text-sm flex flex-col gap-3">
                <a href="{{route('home')}}" class="text-lightText hover:text-danger font-semibold transition ease-in duration-2000">
           ...
           <div class="w-full flex flex-col text-white uppercase">
                  ...
                  <ul class="mt-4 text-sm flex flex-col gap-3">
                      <a href="https://www.ugc.gov.in/Error/Error_404?aspxerrorpath=/page/XI-Plan-Guidelines.aspx#college/" target="_blank" class="text-lightText hover:text-danger font-semibold transition ease-in duration-2000">
                         <li> <i class="fa fa-angles-right text-danger mr-2"></i> UGC</li>
                      </a>
                      <a href="http://www.naac.gov.in" target="_blank" class="text-lightText hover:text-danger font-semibold transition ease-in duration-2000">
                         <li> <i class="fa fa-angles-right text-danger mr-2"></i> NAAC</li>
                      </a>
                      <a href="{{asset('assets/pdf/Alumni Charter.pdf')}}" target="_blank" class="text-lightText hover:text-danger font-semibold transition ease-in duration-2000">

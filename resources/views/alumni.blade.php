    ...
    <div class="w-full flex flex-col items-center lg:pt-[200px] md:pt-[200px] pt-[100px] relative pb-4 px-4">
        ...
        <div class="lg:w-[80%] md:w-[80%] w-full z-20 flex flex-col-reverse gap-4">
            <div class="w-full shadow-lg shadow-black/30 border-[1px] border-white">
                ...
                <div id="alumniTabs" class="w-full rounded-t-md lg:grid md:grid hidden lg:grid-cols-4 md:grid-cols-4 grid-cols-1">
                    <div class="w-full">
                        <a href="{{route('alumni',['type'=>'ALUMNI-CHARTER'])}}">
                            <div class=" group p-2 flex justify-center h-full text-center {{$type==='ALUMNI-CHARTER'?'text-darkTheme bg-white border-[1px] border-darkTheme':'text-white bg-darkTheme border-[1px] border-white'}}  hover:bg-white hover:text-darkText hover:border-darkTheme text-xs font-semibold transition-colors duration-200">
                                <span>
                                    ALUMNI CHARTER
                                </span>
                            </div>
                    ...
                    <div class="w-full">
                        <a href="{{route('alumni',['type'=>'registration'])}}">
                            <div class=" group p-2 flex justify-center h-full text-center {{$type==='registration'?'text-darkTheme bg-white border-[1px] border-darkTheme':'text-white bg-darkTheme border-[1px] border-white'}}  hover:bg-white hover:text-darkText hover:border-darkTheme text-xs font-semibold transition-colors duration-200">
                                <span>
                                   OSA REGISTRATION
                                </span>
                            </div>
                    ...
                    <div class="w-full">
                        <a href="{{route('alumni',['type'=>'ALUMNI-FEEDBACK'])}}">
                            <div class=" group p-2 flex justify-center h-full text-center {{$type==='ALUMNI-FEEDBACK'?'text-darkTheme bg-white border-[1px] border-darkTheme':'text-white bg-darkTheme border-[1px] border-white'}}  hover:bg-white hover:text-darkText hover:border-darkTheme text-xs font-semibold transition-colors duration-200">
                                <span>
                                   ALUMNI FEEDBACK
                                </span>
                            </div>
                    ...
                    <div class="w-full">
                        <a href="{{route('alumni',['type'=>'OUR-ALUMNI'])}}">
                            <div class=" group p-2 flex justify-center h-full text-center {{$type==='OUR-ALUMNI'?'text-darkTheme bg-white border-[1px] border-darkTheme':'text-white bg-darkTheme border-[1px] border-white'}}  hover:bg-white hover:text-darkText hover:border-darkTheme text-xs font-semibold transition-colors duration-200">
                                <span>
                                    OUR ALUMNI
                                </span>
                            </div>
                ...
                <div class="{{$type==='ALUMNI-CHARTER'?'hidden':''}} {{$type==='registration'?'hidden':''}} {{$type==='OUR-ALUMNI'?'hidden':''}} w-full bg-white lg:mt-0 md:mt-0 mt-4 lg:py-8 md:py-8 py-0 rounded-b-md">
                ...
                <div class="{{$type==='ALUMNI-CHARTER'?'':'hidden'}} w-full bg-white  lg:mt-0 md:mt-0 mt-4 lg:py-8 md:py-8 py-0 px-4">
                ...
                <div class="{{$type==='registration'?'':'hidden'}} w-full bg-white  lg:mt-0 md:mt-0 mt-4 lg:py-8 md:py-8 py-0 px-4">
                    <livewire:osa-registration-form />
                </div>

                <div class="{{$type==='OUR-ALUMNI'?'':'hidden'}} w-full bg-white  lg:mt-0 md:mt-0 mt-4 lg:py-8 md:py-8 py-0 px-4">
